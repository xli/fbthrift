...
GD_INSTALL_DIR=/data/users/ilx/scratch/dataZusersZilxZfbsource/fbcode_builder_getdeps/installed

# Order is important – fbcode libs should precede everything else
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/fbcode/platform010/lib:/lib64:/usr/lib64:/home/ilx/.venv
